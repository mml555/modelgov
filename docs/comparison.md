# How Modelgov compares

Modelgov is a **self-hosted AI policy gateway**: policy is checked *before* the
...
| Need | Modelgov | LiteLLM alone | Observability tools (Helicone/Langfuse) | Cloud gateways |
| --- | --- | --- | --- | --- |
...
## When Modelgov is the right fit
...
- You want a fully managed SaaS with zero ops → Modelgov is self-host only today.

## How it relates to LiteLLM

Modelgov sits **in front of** LiteLLM: LiteLLM owns provider credentials and
execution; Modelgov owns policy (budgets, tokens, safety, routing decisions,
