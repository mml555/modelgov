...
Repeatable drill to prove a deployed Modelgov instance is healthy after install, upgrade, or incident recovery.

## Prerequisites

- Running Modelgov API reachable at `MODELGOV_URL`
...
export MODELGOV_API_KEY='your-production-key'
...
```bash
export MODELGOV_URL=http://127.0.0.1:3000
...
```
Modelgov production readiness check
  target: https://modelgov.example.com
