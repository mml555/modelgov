...
export const HYBRID_INJECTION_MODEL = "openai/gpt-4o-mini";
...
export function renderLitellmConfig(
  ...
  const hybridNote = opts?.hybridInjection
    ? "# Hybrid injection: openai/gpt-4o-mini routes to demo-llm so injection\n# screening does not consume cloud free-tier quota.\n"
    : "";
