...
// model classes a common use case needs. `renderAiGuardYaml` turns the chosen
// template into a valid ai-guard.yaml, and the framework adapters use
...
export const TEMPLATES: Record<TemplateId, Template> = {
  ...
  general_gateway: {
    ...
    description: "A single permissive feature to route all product AI through Ai-Guard from day one.",
