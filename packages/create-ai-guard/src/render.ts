...
export function renderEnv(opts: ScaffoldOptions): string {
  ...
  lines.push(
    ...
    "",
    "# Ai-Guard API",
    "# Pin to a digest in production — see https://github.com/mml555/Ai-Guard/pkgs/container/ai-guard-api",
    "AI_GUARD_API_IMAGE=ghcr.io/mml555/ai-guard/ai-guard-api:latest",
    "PORT=3000",
